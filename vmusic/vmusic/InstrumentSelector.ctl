...
Begin VB.UserControl InstrumentSelector 
   ...
   ScaleHeight     =   3255
   ScaleWidth      =   2685
   Begin ComctlLib.ListView lvwInstruments 
      Height          =   2655
      Left            =   0
      TabIndex        =   0
      Top             =   0
...
Private Sub lvwInstruments_ColumnClick(ByVal ColumnHeader As ComctlLib.ColumnHeader)
...
Private Sub lvwInstruments_ItemClick(ByVal Item As ComctlLib.ListItem)
    Dim lsiSelectedListItem As ListItem
...
Private Sub lvwInstruments_OLEStartDrag(Data As ComctlLib.DataObject, AllowedEffects As Long)
    Dim lsiSelectedListItem As ListItem
    Set lsiSelectedListItem = lvwInstruments.SelectedItem
    If Not (lsiSelectedListItem Is Nothing) Then
